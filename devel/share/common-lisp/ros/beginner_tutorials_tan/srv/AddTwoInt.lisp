...
(cl:in-package beginner_tutorials_tan-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoInt-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoInt-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials_tan-srv:<AddTwoInt-request> is deprecated: use beginner_tutorials_tan-srv:AddTwoInt-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <AddTwoInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials_tan-srv:a-val is deprecated.  Use beginner_tutorials_tan-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <AddTwoInt-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials_tan-srv:b-val is deprecated.  Use beginner_tutorials_tan-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddTwoInt-request>)))
  ...
  "beginner_tutorials_tan/AddTwoIntRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddTwoInt-request)))
  "Returns string type for a service object of type 'AddTwoInt-request"
  "beginner_tutorials_tan/AddTwoIntRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoInt-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoInt-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials_tan-srv:<AddTwoInt-response> is deprecated: use beginner_tutorials_tan-srv:AddTwoInt-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <AddTwoInt-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials_tan-srv:sum-val is deprecated.  Use beginner_tutorials_tan-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddTwoInt-response>)))
  ...
  "beginner_tutorials_tan/AddTwoIntResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddTwoInt-response)))
  "Returns string type for a service object of type 'AddTwoInt-response"
  "beginner_tutorials_tan/AddTwoIntResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddTwoInt)))
  ...
  "beginner_tutorials_tan/AddTwoInt")